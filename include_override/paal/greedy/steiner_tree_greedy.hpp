...
class nearest_recorder
  ...
  public:
    ...
    void operator()(Edge const e, Graph const &g) {
        m_nearest_map[boost::target(e, g)] = m_nearest_map[boost::source(e, g)];
        m_vpred[boost::target(e, g)] = e;
    }
...
auto steiner_tree_greedy(const Graph &g, OutputIterator out,
    ...
    std::vector<EdgeTerminal> terminal_edge;
    ...
    auto get_weight=[&](Edge edge){ return get(edge_weight, edge); };
